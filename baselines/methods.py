...
JAVA_DIR = os.path.normpath(os.path.join(_dir, "..", "deps", "java"))
JAVA_CSF_JAR = os.path.join(
    JAVA_DIR, "java-caramel", "target", "java-caramel-1.0-SNAPSHOT.jar"
)
JAVA_MPH_JAR = os.path.join(
    JAVA_DIR, "java-mph", "target", "mph-table-1.0.6-SNAPSHOT.jar"
)
